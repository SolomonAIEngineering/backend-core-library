...
export const ValidationErrorMessageResponse: MessageFns<ValidationErrorMessageResponse> = {
  encode(message: ValidationErrorMessageResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.code !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ValidationErrorMessageResponse {
...
export const InternalErrorMessageResponse: MessageFns<InternalErrorMessageResponse> = {
  encode(message: InternalErrorMessageResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.code !== 0) {
      writer.uint32(8).int32(message.code);
    }
    if (message.message !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): InternalErrorMessageResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const PathUnknownErrorMessageResponse: MessageFns<PathUnknownErrorMessageResponse> = {
  encode(message: PathUnknownErrorMessageResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.code !== 0) {
      writer.uint32(8).int32(message.code);
    }
    if (message.message !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PathUnknownErrorMessageResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ErrorMessageRequest: MessageFns<ErrorMessageRequest> = {
  encode(_: ErrorMessageRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ErrorMessageRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
